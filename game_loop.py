...
class Bullet(pygame.sprite.Sprite):
    ...
    def update(self):
        """ Move the bullet. """
        self.rect.y += math.sin(math.radians(self.theta)) * 10
        self.rect.x += math.cos(math.radians(self.theta)) * 10     
